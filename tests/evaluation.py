...
if __name__ == '__main__':
    ...
    INPUT_FRAMES = 6
    OUTPUT_SHAPE = 128
    BATCH_SIZE = 32 # You can increase this for faster evaluation if GPU memory allows
    
    # --- PATH CONFIGURATION ---
    checkpoint_dir = "/home/sac/data_67/Nowcasting/vinayak/ModelNE/train/checkpoints_full"
    evaluation_output_dir = "/home/sac/data_67/Nowcasting/vinayak/ModelNE/train/evaluation_results"
    os.makedirs(evaluation_output_dir, exist_ok=True)
    
    # Path to the specific checkpoint you want to evaluate
    checkpoint_to_evaluate = os.path.join(checkpoint_dir, "epoch10.ckpt")
    ...
    datamodule = DGMRDataModule(
        dataset_folder="/home/sac/data_67/Nowcasting/data/required_ne",
        csv_path="/home/sac/data_67/Nowcasting/data/input_sequences_ne.csv",
